...
### Trains small MLP on chr10 and tests on chr11 ###
...
def compute_train_stats(train_csv):
    """
    One streaming pass over full training csv to compute feature mean, feature std, class counts, number of rows
    """
    n = 0
...
def train_one_epoch(model, dataloader, optimizer, criterion, mean, std, device):
    ...
    if n_examples == 0:
        raise ValueError("No examples seen in epoch")
...
def train_baseline_model(
    ...
    """
    Train MLP on full chr10 csv, evaluate on full chr11 csv
    """
...
if __name__ == "__main__":
    ...
    EXP_NAME = "baseline_chr10_train_chr11_test"
